...
| -------------------- | ----------------------- |
| Start with solution  | Start with user         |
| Optimise performance | Optimise value          |
| Validate at end      | Test continuously       |
| Technical focus      | Human + technical focus |


## Helpful Resources

### [Design Thinking Bootleg](https://dschool.stanford.edu/tools/design-thinking-bootleg)
![[dschool_bootleg_deck.pdf]]

### [Design Kit: The Human-Centered Design Toolkit](https://www.ideo.com/journal/design-kit-the-human-centered-design-toolkit)
![[field_guide_to_human_centered_design_IDEO.pdf]]
